...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    ...
    loaded = true,
    path = "/home/benyamin/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/benyamin/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["vim-closetag"] = {
    loaded = true,
    path = "/home/benyamin/.local/share/nvim/site/pack/packer/start/vim-closetag",
